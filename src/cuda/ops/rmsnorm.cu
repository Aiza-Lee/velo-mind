...
static ::velomind::internal::KernelRegistrar _velomind_kr_rmsnorm_f32(
    DeviceType::CUDA, Op::RMSNorm,
    ::velomind::internal::KernelDtypeKey{
        { DataType::Float32, DataType::Float32 }, 2, DataType::Float32 },
    static_cast<Executable::KernelFn>(&rmsnorm_impl<float, float, float>));

static ::velomind::internal::KernelRegistrar _velomind_kr_rmsnorm_f16(
    DeviceType::CUDA, Op::RMSNorm,
    ::velomind::internal::KernelDtypeKey{
        { DataType::Float16, DataType::Float16 }, 2, DataType::Float16 },
    static_cast<Executable::KernelFn>(&rmsnorm_impl<float16_t, float16_t, float16_t>));

static ::velomind::internal::KernelRegistrar _velomind_kr_rmsnorm_bf16(
    DeviceType::CUDA, Op::RMSNorm,
    ::velomind::internal::KernelDtypeKey{
        { DataType::BFloat16, DataType::BFloat16 }, 2, DataType::BFloat16 },
    static_cast<Executable::KernelFn>(&rmsnorm_impl<bfloat16_t, bfloat16_t, bfloat16_t>));

static ::velomind::internal::KernelRegistrar _velomind_kr_rmsnorm_f32_f16(
    DeviceType::CUDA, Op::RMSNorm,
    ::velomind::internal::KernelDtypeKey{
        { DataType::Float32, DataType::Float16 }, 2, DataType::Float32 },
    static_cast<Executable::KernelFn>(&rmsnorm_impl<float, float16_t, float>));

static ::velomind::internal::KernelRegistrar _velomind_kr_rmsnorm_f32_bf16(
    DeviceType::CUDA, Op::RMSNorm,
    ::velomind::internal::KernelDtypeKey{
        { DataType::Float32, DataType::BFloat16 }, 2, DataType::Float32 },
    static_cast<Executable::KernelFn>(&rmsnorm_impl<float, bfloat16_t, float>));
